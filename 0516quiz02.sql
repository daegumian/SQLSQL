...
SELECT CONCAT(FIRST_NAME,LAST_NAME), REPLACE(HIRE_DATE,'/','') AS 입사일자 FROM EMPLOYEES ORDER BY FIRST_NAME ASC;
---TEACHER--
...
SELECT CONCAT('(O2)',(SUBSTR(PHONE_NUMBER,4,15))) AS 전화번호 FROM EMPLOYEES;
--TEACHER--
